...
# Load media files
img1 = Image.open(r"C:\Users\dhrum\PycharmProjects\FitBot\images\yoga.jpg")
img2 = Image.open(r"C:\Users\dhrum\PycharmProjects\FitBot\images\pranamasana2.png")
img3 = Image.open(r"C:\Users\dhrum\PycharmProjects\FitBot\images\pranamasana.png")
img4 = Image.open(r"C:\Users\dhrum\PycharmProjects\FitBot\images\Ashwa_Sanchalanasana.webp")
img5 = Image.open(r"C:\Users\dhrum\PycharmProjects\FitBot\images\ardha_chakrasana.webp")
img6 = Image.open(r"C:\Users\dhrum\PycharmProjects\FitBot\images\Utkatasana.png")
img7 = Image.open(r"C:\Users\dhrum\PycharmProjects\FitBot\images\Veerabhadrasan_2.png")
        ...
        try:
            ...
            if pose_number == 1:
                ...
                if left_angle < 100 and right_angle < 100 and distance < 0.1:
                    ...
                    cv2.putText(image, f"TIME: {int(counter)}s", (50, 100), cv2.FONT_HERSHEY_SIMPLEX, 1,
                                (255, 255, 255), 2)
                else:
